...
/**
 * clase de CLIENTE para estructura cliente/servidor multihilo, actividad 1 del segundo trimestre de la asignatura PROGRAMACION DE SERVICIOS Y PROCESOS DE 2 DE DAM
 * */
public class Client {
    public static void main(String[] args) {
        ...
        try {
            ...
            while (!texto.equals("FIN")) {
                ...
                System.out.println("server.Servidor responde: " + new String(mensaje).trim());
            }
            entrada.close();
            salida.close();
            cliente.close();
